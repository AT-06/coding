 ...
 */
public class CesarCryptTest {

    /**
     *
     */
    private CesarCrypt cesar;
    ...
    public void shouldDecipher() {
        ...
        final int key2 = -2;
        String s = "aoeu";
        String encrypted = cesar.encode(s, key1);
        assertEquals(s, cesar.encode(encrypted, key2));
    }
    ...
    public void testEncodeWithPositiveKey() {
        final int key1 = 3;
        final int key2 = 5;
        assertEquals("KROD", cesar.encode("HOLA", key1));
        assertEquals("ETWWT", cesar.encode("ZORRO", key2));
    }
    ...
    public void testEncodeWithNegativeKey() {
        final int key = -3;
        assertEquals("HOLA", cesar.encode("KROD", key));
    }
    ...
    public void testEncodeWithNullMessage() {
        final int key = 5;
        assertEquals("", cesar.encode(null, key));
        assertEquals("", cesar.encode(null, key));
    }
