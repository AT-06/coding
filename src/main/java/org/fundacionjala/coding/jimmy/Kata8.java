...
class Kata8 {
     ...
     */
    Kata8(final String ocrAccountNumber) {
     ...
     */
    private static String parseDigit(final String ocrAccountNumber, final int digit) {
     ...
     */
    private static String createAccountNumberFromOcr(final String ocrToInterpret) {
